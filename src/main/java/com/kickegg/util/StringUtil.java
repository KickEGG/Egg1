...
public final class StringUtil {
    ...
    public static String toPascalStyle(String str ,String seperator) {
        return com.kickegg.util.StringUtil.firstToUpper(toCamelhumpStyle(str, seperator));
    }
    /**
     * 转为驼峰命令方式（如：fooBar）
     */
    public static String toCamelhumpStyle(String str,String seperator) {
        return com.kickegg.util.StringUtil.unerlineToCamelhump(toUnderlineStyle(str, seperator));
    }
    ...
    public static String toDisplayStyle(String str, String seperator) {
        ...
        str = str.trim().toLowerCase();
        if (str.contains(seperator)) {
            String[] words = com.kickegg.util.StringUtil.splitString(str, seperator);
            for (String word : words) {
                displayName += com.kickegg.util.StringUtil.firstToUpper(word)+"";
            }
        }else {
            displayName = com.kickegg.util.StringUtil.firstToUpper(str);
        }
        return displayName;
    }
}